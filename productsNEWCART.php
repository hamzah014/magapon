...
if(isset($_POST['update_update_btn'])){
   ...
   if($update_quantity_query){
      header('location:productsNEWCART.php');
   };
};
    ...
    <div class="container" style="margin-bottom: 300px;">
        ...
        <div class="row">
         ...
         ?>
                    ...
                    <tr>
                        <td><img src="imagesupload/<?php echo $fetch_cart['cart_image']; ?>" height="100" alt=""></td>
                        <td><?php echo $fetch_cart['cart_name']; ?></td>
                        <td>RM<?php echo ($fetch_cart['cart_price']); ?></td>
                        <td>
                            <form action="" method="post">
                                ...
                                <input type="number" name="update_quantity" min="1"
                                    value="<?php echo $fetch_cart['cart_quantity']; ?>">
                                <input type="submit" value="update" name="update_update_btn">
                            </form>
                        </td>
                        <td>RM<?php echo $sub_total = ($fetch_cart['cart_price'] * $fetch_cart['cart_quantity']); ?>
                        </td>
                        <td><a href="productsNEWCART.php?remove=<?php echo $fetch_cart['cart_id']; ?>"
         ...
         ?>
                    <tr class="table-bottom">
                        <td><a href="productsNEWUSER.php" class="option-btn" style="margin-top: 30px;">Continue
                                Shopping</a>
                        </td>
                        <td colspan="3" style="padding-left: 520px;"><b>Grand Total</b></td>
                        <td><b>RM<?php echo $grand_total; ?></b></td>
                        <td><a href="productsNEWCART.php?delete_all"
            ...
            <div class="checkout-btn">
                <a href="productsNEWCHECKOUT.php?grandtotal=<?php echo $grand_total ?>">Proceed to
                    Checkout</a>
            </div>
        </div>
    </div>
