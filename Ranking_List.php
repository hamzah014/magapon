        ...
        <div class="row">
            ...
            <div class="col-8">
                <div class="contact-form">
                    <form id="contact" action="Ranking_List.php" method="post">
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <label for="validationPartID" class="form-label">Participants ID:</label>
                                <input type="text" class="form-control" name="user_part_id"
                                    placeholder="Participants ID" id="validationPartID"
                                    aria-describedby="inputGroupPrepend2" required>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <label for="validationFishWeight" class="form-label">Fish Weight:</label>
                                <input type="text" class="form-control" name="fish_weight" placeholder="Fish Weight"
                                    id="validationFishWeight" aria-describedby="inputGroupPrepend2" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
